...
public class DowloadTrackService extends IntentService {
    ...
    public static Intent getDowloadService(Context context, Track track) {
    ...
    private void startDowload(Track track) {
        ...
        String part = String.format(BASE_FILE_PATH, track.getTitle().replaceAll("/", "_"));
        DownloadManager.Request request = new DownloadManager.Request(Uri.parse(urlDowload));
        request.setAllowedNetworkTypes(DownloadManager.Request.NETWORK_MOBILE | DownloadManager.Request.NETWORK_WIFI);
        request.allowScanningByMediaScanner();
        request.setTitle("Download " + track.getTitle());
